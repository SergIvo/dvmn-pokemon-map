...
Чтобы сайт работал корректно, необходимо выполнить миграции базы данных:

```sh
python3 manage.py migrate
```

Для предварительного наполнения базы данных вам потребуется создать учетную запись администратора. Создайте ее следующей командой:
