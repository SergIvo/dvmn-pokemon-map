# Generated by Django 3.1.14 on 2022-10-26 21:14
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('pokemon_entities', '0009_auto_20221026_2053'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='pokemon',
            name='previous_form',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='next_form', to='pokemon_entities.pokemon', verbose_name='Предыдущая ступень эволюции'),
        ),
        migrations.AlterField(
            model_name='pokemon',
            name='title',
